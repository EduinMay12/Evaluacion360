<div class="form-group"> 
    ...
    <div class="form-group {{ $errors->has('descripcion') ? 'has-error' : ''}}">
        ...
        <input class="form-control" name="descripcion" type="text" id="descripcion" value="{{ isset($competencium->descripcion) ? $competencium->descripcion : ''}}" >
    ...
    <br>
        <div class="row">
            <div class="col {{ $errors->has('basicocorto1') ? 'has-error' : ''}}">
                ...
                <input class="form-control" name="basicocorto1" type="text" id="basicocorto1" value="{{ isset($competencium->basicocorto1) ? $competencium->basicocorto1 : ''}}" >
            ...
            <div class="col {{ $errors->has('basicocorto2') ? 'has-error' : ''}}">
                ...
                <input class="form-control" name="basicocorto2" type="text" id="basicocorto2" value="{{ isset($competencium->basicocorto2) ? $competencium->basicocorto2 : ''}}" >
            ...
            <div class="col {{ $errors->has('basicocorto3') ? 'has-error' : ''}}">
                ...
                <input class="form-control" name="basicocorto3" type="text" id="basicocorto3" value="{{ isset($competencium->basicocorto3) ? $competencium->basicocorto3 : ''}}" >
    ...
    <br>
        <div class="row">
            <div class="col {{ $errors->has('basicoaccion1') ? 'has-error' : ''}}">
                ...
                <input class="form-control" name="basicoaccion1" type="text" id="basicoaccion1" value="{{ isset($competencium->basicoaccion1) ? $competencium->basicoaccion1 : ''}}" >
            ...
            <div class="col {{ $errors->has('basicoaccion2') ? 'has-error' : ''}}">
                ...
                <input class="form-control" name="basicoaccion2" type="text" id="basicoaccion2" value="{{ isset($competencium->basicoaccion2) ? $competencium->basicoaccion2 : ''}}" >
            ...
            <div class="col {{ $errors->has('basicoaccion3') ? 'has-error' : ''}}">
                ...
                <input class="form-control" name="basicoaccion3" type="text" id="basicoaccion3" value="{{ isset($competencium->basicoaccion3) ? $competencium->basicoaccion3 : ''}}" >
    ...
    <br>
        <div class="row">
            <div class="col {{ $errors->has('calificadocorto1') ? 'has-error' : ''}}">
                ...
                <input class="form-control" name="calificadocorto1" type="text" id="calificadocorto1" value="{{ isset($competencium->calificadocorto1) ? $competencium->calificadocorto1 : ''}}" >
            ...
            <div class="col {{ $errors->has('calificadocorto2') ? 'has-error' : ''}}">
                ...
                <input class="form-control" name="calificadocorto2" type="text" id="calificadocorto2" value="{{ isset($competencium->calificadocorto2) ? $competencium->calificadocorto2 : ''}}" >
            ...
            <div class="col {{ $errors->has('calificadocorto3') ? 'has-error' : ''}}">
                ...
                <input class="form-control" name="calificadocorto3" type="text" id="calificadocorto3" value="{{ isset($competencium->calificadocorto3) ? $competencium->calificadocorto3 : ''}}" >
    ...
    <br>
        <div class="row">
            <div class="col {{ $errors->has('calificadoaccion1') ? 'has-error' : ''}}">
                ...
                <input class="form-control" name="calificadoaccion1" type="text" id="calificadoaccion1" value="{{ isset($competencium->calificadoaccion1) ? $competencium->calificadoaccion1 : ''}}" >
            ...
            <div class="col {{ $errors->has('calificadoaccion2') ? 'has-error' : ''}}">
                ...
                <input class="form-control" name="calificadoaccion2" type="text" id="calificadoaccion2" value="{{ isset($competencium->calificadoaccion2) ? $competencium->calificadoaccion2 : ''}}" >
            ...
            <div class="col {{ $errors->has('calificadoaccion3') ? 'has-error' : ''}}">
                ...
                <input class="form-control" name="calificadoaccion3" type="text" id="calificadoaccion3" value="{{ isset($competencium->calificadoaccion3) ? $competencium->calificadoaccion3 : ''}}" >
    ...
    <br>
        <div class="row">
            <div class="col {{ $errors->has('experimentadocorto1') ? 'has-error' : ''}}">
                ...
                <input class="form-control" name="experimentadocorto1" type="text" id="experimentadocorto1" value="{{ isset($competencium->experimentadocorto1) ? $competencium->experimentadocorto1 : ''}}" >
            ...
            <div class="col {{ $errors->has('experimentadocorto2') ? 'has-error' : ''}}">
                ...
                <input class="form-control" name="experimentadocorto2" type="text" id="experimentadocorto2" value="{{ isset($competencium->experimentadocorto2) ? $competencium->experimentadocorto2 : ''}}" >
            ...
            <div class="col {{ $errors->has('experimentadocorto3') ? 'has-error' : ''}}">
                ...
                <input class="form-control" name="experimentadocorto3" type="text" id="experimentadocorto3" value="{{ isset($competencium->experimentadocorto3) ? $competencium->experimentadocorto3 : ''}}" >
    ...
    <br>
        <div class="row">
            <div class="col {{ $errors->has('experimentadoaccion1') ? 'has-error' : ''}}">
                ...
                <input class="form-control" name="experimentadoaccion1" type="text" id="experimentadoaccion1" value="{{ isset($competencium->experimentadoaccion1) ? $competencium->experimentadoaccion1 : ''}}" >
            ...
            <div class="col {{ $errors->has('experimentadoaccion2') ? 'has-error' : ''}}">
                ...
                <input class="form-control" name="experimentadoaccion2" type="text" id="experimentadoaccion2" value="{{ isset($competencium->experimentadoaccion2) ? $competencium->experimentadoaccion2 : ''}}" >
            ...
            <div class="col {{ $errors->has('experimentadoaccion3') ? 'has-error' : ''}}">
                ...
                <input class="form-control" name="experimentadoaccion3" type="text" id="experimentadoaccion3" value="{{ isset($competencium->experimentadoaccion3) ? $competencium->experimentadoaccion3 : ''}}" >
